...
objects = Event.o Simulation.o Burst.o ListItem.o Node.o ParentQueue.o PriorityQueue.o Process.o Queue.o FileReader.o StartCPU.o ProcessArrival.o Timeout.o CompleteCPU.o# .. etc .. put a list of your .o files here  
